    ...
    <div class="m-12">
        ...
        <div class="rounded-md hero bg-blue-50">
            <div class="hero-content flex-col lg:flex-row">
                <img src="https://i.pinimg.com/564x/e9/a2/3b/e9a23b37bc304e72db21ad2680b87ee5.jpg" class="h-64 rounded-lg shadow-2xl" />
                <div>
    ...
    <div class="m-12">
        ...
        <div class="grid grid-cols-5 gap-6">
            <div class="card bg-base-100 shadow-xl">
                <figure><img src="https://i.pinimg.com/564x/b6/4e/4e/b64e4e6cf83da7959b22038ef7097105.jpg" alt="Shoes" /></figure>
                <div class="m-4">
